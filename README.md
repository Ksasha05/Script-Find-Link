# Script-Find-Link
Скрипт для поиска ссылки на страницах<br>
Осталась одна проблема - если страница в течении минуты не может полностью загрузиться, то вылетает ошибка о слишком долгом ожидании<br>
Не помню как решал данную проблему раньше(
